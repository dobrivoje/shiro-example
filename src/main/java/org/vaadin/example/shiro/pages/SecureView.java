...
import org.vaadin.example.shiro.FileUploader.UploadReceiver;
...
public class SecureView extends SecureAccessView {
    ...
    // private static final String imageStoreLocation = "\\\\CENTURION\\Users\\Public\\Downloads\\";
    ...
    protected void createView() {
        ...
        final UploadReceiver uploadReceiver = new UploadReceiver(progressBar, this, imageStoreLocation);
        ...
        for (int i = 0; i < 8; i++) {
            ...
            im.addClickListener((MouseEvents.ClickEvent event) -> {
        ...
        logoutButton = new Button("Logout", (Button.ClickEvent event) -> {
